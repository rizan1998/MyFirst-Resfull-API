...
|
*/
$config['rest_auth'] = 'basic'; //default FALSE
...
|
*/
$config['auth_source'] = ''; //default ldap tapi kosongkan terlebih dahulu untuk latihan
...
|
*/
$config['rest_valid_logins'] = ['admin' => '1234', 'rizan1998' => '1234']; // yg ini untuk default login sehingga nanti 
//ngambilnya di database
//untuk login pada postman ada di authorization
//pilih basic aut atau samakan yg diatasnya pakai apa
//lalu masukan username dan passwordnya pada basic aut ldap nya kosongin dulu agar tidak error
...
|
*/
$config['rest_enable_keys'] = TRUE; //DEFAULT FALSE ganti jadi TRUE supaya butuh key
//supaya user barunya punya key maka input manual key baru menggunakan phpmyadmin
//dan untuk kedepannya bisa digabungkan dengan table usernya
...
|
*/
$config['rest_key_length'] = 40; //MAXIMUM KEY
...
|
*/
$config['rest_key_name'] = 'wpu-key'; //NAMA KEY jangan lupa create tabel key nya
//ini berlaku untuk semua method GET, DELETE, PUT dll
//nanri kirim di postmant nya X-API-KEY terus masukan key yg di database
...
*/
$config['rest_enable_limits'] = TRUE; //DEFAULT FALSE
//SETELAH DIBIKIN TABLE DAN TRUE MAKA KASIH TAU CONTROLLER DENGAN SKRIP $this->method[']
//aturan method di atas limitnya per jam
//dan aturan limitnya akan di rekam pada table yang sudah di buat atau pada tabel limit
